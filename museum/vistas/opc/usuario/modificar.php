...
<body>
	...
	?>
	<form action="edicion.php?idusuario=<?php echo $row['idusuario'];?>" method="POST">
		
		<p>Nombre: <input type="text" name="nombre" value="<?php echo $row['nombre']?>"></p><br>
		<p>Usuario: <input type="text" name="username" value="<?php echo $row['username']?>"></p><br>
		<p>Contraseña: <input type="password" name="password" value="<?php echo $row['password']?>"></p><br>
		<p><input type="submit"  value = "Guardar"></p>
	</form>
	
	<br><a href="../../../vistas/opc/usuario/ver.php"> <input type="submit"  value = "Cancelar"></a>
	</center>
