...
<body>
	...
	<center>
				...
				<tbody>
					<thead>
						<tr>
							...
							<td>PROCEDENCIA</td>
							<td>PROFESOR</td>
							<td>ESTUDIANTE BASICO</td>
							<td>ESTUDIANTE SUPERIOR</td>
							<td>JUBILADO/3raEDAD</td>
							<td>DISCAPACITADO</td>
							<td>EXTRANJERO</td>
							<td>CUOTA</td>
							<td>EDITAR</td>
					...
					?>
						<tr>
							<td><?php echo $row['idvis']; ?></td>
							<td><?php echo $row['nombre']; ?></td>
							<td><?php echo $row['apellido']; ?></td>
							<td><?php echo $row['procedencia']; ?></td>
							<td><?php echo $row['profesor']; ?></td>
							<td><?php echo $row['estudiantebas']; ?></td>
							<td><?php echo $row['estudiantesup']; ?></td>
							<td><?php echo $row['jubilado']; ?></td>
							<td><?php echo $row['discapacitado']; ?></td>
							<td><?php echo $row['extranjero']; ?></td>
							<td><?php echo $row['cuota']; ?></td>
							<td>
								<a href="../../../vistas/opc/visitantes/modificar.php?idvis=<?php echo $row['idvis'];?>">
    							<img class="editar" src="../../../vistas/imagen/edit.jpg" alt="Editar" title="Editar" width="35" height="35"></a> 
							</td>
							<td>
								<a href="../../../vistas/opc/visitantes/eliminar.php?idvis=<?php echo $row['idvis'];?>">
		...
		<br><br><a href="../../../vistas/opc/visitantes/nuevo.php">
