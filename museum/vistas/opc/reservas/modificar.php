...
<body>
	...
	<?php
		...
		$query="SELECT * FROM reserva WHERE idres='$idres'";
		$resultado= $conexion->query($query);
		$row=$resultado->fetch_assoc();
	?>
	<form action="edicion.php?idres=<?php echo $row['idres'];?>" method="POST">
    ...
    <p>Numero de Alumnos: <input type="number" name="numalumno" value="<?php echo $row['numalumno']?>"></p><br>
    <p>Numero de Profesores: <input type="number" name="numprofesor" value="<?php echo $row['numprofesor']?>"></p><br>
    <p>Fecha: <input type="date" name="fecha" value="<?php echo $row['fecha']?>"></p><br>
