...
<body>
	...
	<center>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?php echo $row['numalumno']; ?></td>
							<td><?php echo $row['numprofesor']; ?></td>
							<td><?php echo $row['fecha']; ?></td>
							<td>
								<a href="../../../vistas/opc/reservas/modificar.php?idres=<?php echo $row['idres'];?>">
    							<img class="editar" src="../../../vistas/imagen/edit.jpg" alt="Editar" title="Editar" width="35" height="35"></a> 
							</td>
							<td>
								<a href="../../../vistas/opc/reservas/eliminar.php?idres=<?php echo $row['idres'];?>">
		...
		<br><br><a href="../../../vistas/opc/reservas/nuevo.php">
		<input type="submit" value="REGISTRAR RESERVACION"></a>
	</center>
</body>
</html>